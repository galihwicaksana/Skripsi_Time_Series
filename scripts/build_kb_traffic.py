"""
Script to build Knowledge Base from Traffic training data for RAF-TimeMixer
Traffic dataset has 862 features - we'll use smaller d_model
"""
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Build Knowledge Base for RAF-TimeMixer - Traffic')
    ...
    # Model define - Traffic has 862 features
    parser.add_argument('--enc_in', type=int, default=862)
    parser.add_argument('--dec_in', type=int, default=862)
    parser.add_argument('--c_out', type=int, default=862)
    parser.add_argument('--d_model', type=int, default=32)  # Larger for more features
    parser.add_argument('--n_heads', type=int, default=8)
    parser.add_argument('--e_layers', type=int, default=2)
    parser.add_argument('--d_layers', type=int, default=1)
    parser.add_argument('--d_ff', type=int, default=64)  # Larger for more features
    ...
    parser.add_argument('--raf_d_embed', type=int, default=32)  # Match d_model
    ...
    # Knowledge Base
    parser.add_argument('--kb_path', type=str, default='./checkpoints/knowledge_bases/traffic_kb.pkl')
